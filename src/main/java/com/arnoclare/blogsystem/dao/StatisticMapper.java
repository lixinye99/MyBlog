...
public interface StatisticMapper {
    ...
    @Select("SELECT s.* FROM t_statistic s, t_comment c " +
            "WHERE c.id = #{commentId} AND c.article_id = s.article_id")
    public Statistic selectStatisticWithCommentId(Integer commentId);
}
