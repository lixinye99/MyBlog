...
public class ArticleServiceImpl implements IArticleService {
    ...
    // 分页查询文章列表
    @Cacheable(cacheNames = "articleWithPage")
    @Override
    ...
    // 发布文章
    @Caching(evict = {
            @CacheEvict(cacheNames = "tags"),
            @CacheEvict(cacheNames = "articleWithPage")
    })
    @Override
    ...
    public List<String> selectAllTags() {
        // 获取所有 tags 原始字符串
        List<String> tags = articleMapper.selectAllTags();
        // 使用 Set 去重
